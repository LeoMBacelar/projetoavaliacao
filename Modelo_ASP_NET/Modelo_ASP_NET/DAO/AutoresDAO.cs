...
namespace Modelo_ASP_NET.DAO
{
    ...
    {
        //Instanciando o objeto SqlCommand para enviar comandos ao banco de dados.
        SqlCommand ioQuery;
        ...
        {
            // Instanciou um objeto Autor com os parâmetros
            Autores loAutor = new Autores(-1, "vazio", "vazio", "vazio");

            //abrindo um comando de leitura com conexão ao banco de dados
